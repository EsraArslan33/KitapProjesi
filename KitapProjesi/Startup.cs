    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           services.AddDbContext<Context>(option=>option.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
            services.AddTransient<IGenericDal<Book>, GenericRepository<Book>>();
            services.AddTransient<IGenericDal<Category>, GenericRepository<Category>>();
